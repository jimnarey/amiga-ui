...
- Each new feature, fix, or documentation task should use its own branch created from `development`.
...
6. Stop when the app advances to a new blocker, or when the blocker is out of scope and should be documented instead of patched around.
