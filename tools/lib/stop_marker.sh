#!/usr/bin/env bash
# Shared helpers for writing and reading harness stop markers
# (<state_dir>/allow-stop.json). Preserved for deprecated harness helpers
# under .deprecated/. Not meant to be invoked directly.
#
